...
namespace Theater.Business {
    ...
    public class ShowService : IShowService {
        ...
        public Show? GetShowByTitle(string title) => _showRepository.GetShowByTitle(title);
        ...
        public List<Session> GetSessionsByShow(int showId) => _showRepository.GetSessionsByShow(showId);
    }
